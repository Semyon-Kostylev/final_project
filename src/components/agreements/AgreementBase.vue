<template>
  <div class="agreement">
    <div v-click-outside="onClickOutside" class="agreement__modal modal">
      <button @click="$emit('close-modal')" class="modal__close">×</button>
      <h1 class="modal__title">Пользовательское соглашение</h1>
      ...
      >
        ...
        которую сайт «IDPowers.com», расположенный на доменном имени
        https://www.idpowers.com/, может получить о Пользователе во время
        использования сайта.
        </p>
        ...
        <p>
          1.1.1. «Администрация
          сайта (далее – Администрация сайта)» – уполномоченные сотрудники на
          управления сайтом, действующие от имени ООО “Смарт Технолоджис”, которые
